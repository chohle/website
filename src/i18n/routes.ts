...
const SEGMENTS: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "sending-email": { de: "email-versand", fr: "envoi-email", it: "invio-email" },
  expenses: { de: "ausgaben", fr: "depenses", it: "uscite" },
  income: { de: "einnahmen", fr: "revenus", it: "entrate" },
  triage: { de: "triage", fr: "triage", it: "triage" },
  ...
  customers: { de: "kunden", fr: "clients", it: "clienti" },
  articles: { de: "artikel", fr: "articles", it: "articoli" },
