...
const linkTitles: Record<string, Record<Lang, string>> = {
  ...
  "/docs/sending-email": { en: "Sending email", de: "E-Mail-Versand", fr: "Envoi d'e-mails", it: "Invio di e-mail" },
  "/docs/expenses": { en: "Expenses", de: "Ausgaben", fr: "Dépenses", it: "Uscite" },
  "/docs/income": { en: "Income", de: "Einnahmen", fr: "Revenus", it: "Entrate" },
  "/docs/triage": { en: "Triage", de: "Triage", fr: "Triage", it: "Triage" },
  ...
  "/docs/customers": { en: "Customers", de: "Kunden", fr: "Clients", it: "Clienti" },
  "/docs/articles": { en: "Articles", de: "Artikel", fr: "Articles", it: "Articoli" },
